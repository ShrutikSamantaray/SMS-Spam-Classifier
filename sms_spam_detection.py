...
Original file is located at
    https://colab.research.google.com/drive/1bWlYf_2tYsq03F1NJ35DeZq9lHOR5B5M
"""
...
# Assuming spam_corpus is defined somewhere in your code
...
# Plot the barplot
sns.barplot(data=df_most_common, x='Word', y='Count')
...
# Assuming ham_corpus is defined somewhere in your code
...
tfidf = TfidfVectorizer(lowercase=True, stop_words='english')  # Corrected class name
